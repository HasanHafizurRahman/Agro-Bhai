...
const Portfolio = () => {
    return (
        <div className='grid grid-cols-1 justify-center px-60'>
            ...
            <h3 className='text-2xl text-primary font-bold'>Education: B.A.(Hons), 4th year - 2nd semister, Jagannath University</h3>
            <h3 className='text-2xl'><span className='text-secondary font-bold'>Technologies I know:</span> Html, Css, Javascript, Reactjs, Bootstrap , React-bootsrap, Tailwind, Daisy-Ui, Mongodb, Nodejs, ExpressJs, Firebase etc.</h3>
